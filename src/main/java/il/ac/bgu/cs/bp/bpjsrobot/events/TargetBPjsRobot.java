...
public class TargetBPjsRobot extends BPjsRobot {

    BPjsRobot robot = this;

    protected SingleResourceBProgram bprog = new SingleResourceBProgram("TargetBP.js", "TargetBP.js", new SimpleEventSelectionStrategy()) {
